...
import { User, Shield, Bell, Palette, Link2, Download, Keyboard, Lock } from 'lucide-react'
...
// Barrel re-exports for sub-components (merged from deleted index.js)
export { ProfileSettings, SecuritySettings, NotificationSettings, PreferencesSettings, ConnectedAccounts, DataExport, KeyboardShortcuts, PrivacySettings }
