...
const SYSTEM_DIR = path.join(MIGRATIONS_ROOT, '@system')
const CUSTOM_DIR = path.join(MIGRATIONS_ROOT, '@custom')

const EXCLUDED = new Set(['run.js', 'index.js', 'create.js', 'precheck.js', 'start.js'])
